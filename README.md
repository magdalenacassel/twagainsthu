...
get the app created:
    ...
    $ heroku apps:create twagainsthu
    Creating twagainsthu... done, stack is cedar
    http://twagainsthu.herokuapp.com/ | git@heroku.com:twagainsthu.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://twagainsthu.herokuapp.com deployed to Heroku

    To git@heroku.com:twagainsthu.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://twagainsthu.herokuap.com
    ["Hello" :from Heroku]
